package com.laioffer.job.servlet.db;

import com.laioffer.job.servlet.entity.Item;
...
public class MySQLConnection {
    ...
    public void saveItem(Item item) {
        ...
        String insertItemSql = "INSERT INTO items VALUES (?, ?, ?, ?, ?)";
        try {
        ...
        String insertKeywordSql = "INSERT INTO keywords VALUES (?, ?)";
        try {
